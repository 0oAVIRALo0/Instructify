...
import {
  registerLimiter,
  loginLimiter,
} from "../middlewares/rate_limiter/auth.js";
...
router
  ...
  .get(verifyJWT, verifyRole("admin"), getAllStudents);
router
  .route("/get-all-instructors")
  .get(verifyJWT, verifyRole("admin"), getAllInstructors);
router
  .route("/assign-course-to-instructor")
  .post(verifyJWT, verifyRole("admin"), assignCourseToInstructor);
// router
//   .route("/get-assigned-courses")
//   .get(verifyJWT, verifyRole("admin"), getAssignedCourses);
...
// router
//   .route("/get-courses")
//   .get(verifyJWT, verifyRole("instructor"), getCourses);

// secured route + student role
// router
//   .route("/enroll/:courseId")
//   .post(verifyJWT, verifyRole("student"), enrollInCourse);
// router
//   .route("/unenroll/:courseId")
//   .delete(verifyJWT, verifyRole("student"), unenrollInCourse);
// router
//   .route("/get-enrolled-courses")
//   .get(verifyJWT, verifyRole("student"), getEnrolledCourses);
// router
//   .route("/get-video/:videoId")
//   .get(verifyJWT, verifyRole("student"), getVideo);
